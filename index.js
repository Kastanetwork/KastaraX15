...
const more = String.fromCharCode(8206)
const strip_ny = more.repeat(4001)
var footer_nya =`${setting.foother}`
let tampilan_nya = `Hallo @${sender.split('@')[0]}👋\n\`\`\`Saya adalah Bot WhatsApp Yang bernama ${setting.botName}\nBerikut Adalah List menu dari ${setting.botName}\n\`\`\`
`
conn.sendMessage(from,
{text: tampilan_nya,
buttonText: "Click Here",
sections: [{title: "━━━━━━━━━━━━[ 𝗗𝗮𝘁𝗮 𝗕𝗼𝘁 ]━━━━━━━━━━━━",
rows: [
{title: "📃 ┆» 𝗥𝘂𝗹𝗲𝘀 𝗕𝗼𝘁", rowId: prefix+"rules", description: "Peraturan Dalam menggunakan Bot"},
{title: "📮 ┆» 𝗦𝗰𝗿𝗶𝗽𝘁 𝗕𝗼𝘁", rowId: prefix+"sc", description: "Penjual Script Bot"},
{title: "👨‍💻 ┆» 𝗖𝗼𝗻𝘁𝗿𝗶𝗯𝘂𝘁𝗼𝗿𝘀", rowId: prefix+"thanksto", description: "Siapa Saja Yang Berkontribusi Di Dalam Bot Ini"},
{title: "💰 ┆» 𝗗𝗼𝗻𝗮𝘁𝗲", rowId: prefix+"donasi", description: "Donasi Kepada Bot"}]},
{title: "━━━━━━━━━━━━[ 𝗟𝗶𝘀𝘁 𝗠𝗲𝗻𝘂 ]━━━━━━━━━━━━",
rows: [
{title: "💬 ┆» 𝗔𝗹𝗹 𝗠𝗲𝗻𝘂", rowId: prefix+"allmenu", description: "Menampilkan Semua Fitur"},
{title: "🪀 ┆» 𝗠𝗮𝗶𝗻 𝗠𝗲𝗻𝘂", rowId: prefix+"maincmd", description: "Menampilkan Fitur Main"},
{title: "🤴 ┆» 𝗢𝘄𝗻𝗲𝗿 𝗠𝗲𝗻𝘂", rowId: prefix+"ownercmd", description: "Menampilkan Fitur Owner"},
{title: "🏢 ┆» 𝗚𝗿𝘂𝗽 𝗠𝗲𝗻𝘂", rowId: prefix+"groupcmd", description: "Menampilkan Fitur Grup"},
{title: "🎮 ┆» 𝗚𝗮𝗺𝗲 𝗠𝗲𝗻𝘂", rowId: prefix+"gamecmd", description: "Menampilkan Fitur Game"},
{title: "📮 ┆» 𝗥𝗮𝗻𝗱𝗼𝗺 𝗠𝗲𝗻𝘂", rowId: prefix+"randomcmd", description: "Menampilkan Fitur Random"},
{title: "🎶 ┆» 𝗦𝗼𝘂𝗻𝗱 𝗠𝗲𝗻𝘂", rowId: prefix+"soundcmd", description: "Menampilkan Fitur Sound"},
{title: "📼 ┆» 𝗔𝘂𝗱𝗶𝗼 𝗖𝗵𝗮𝗻𝗴𝗲𝗿 ", rowId: prefix+"audiocmd", description: "Menampilkan Fitur Audio Changer"},
{title: "🚹 ┆» 𝗔𝗻𝗼𝗻𝘆𝗺𝗼𝘂𝘀 𝗠𝗲𝗻𝘂", rowId: prefix+"anonymouscmd", description: "Menampilkan Fitur Anonymous Chat"},
{title: "💌 ┆» 𝗠𝗲𝗻𝗳𝗲𝘀𝘀 𝗠𝗲𝗻𝘂", rowId: prefix+"menfesscmd", description: "Menampilkan Fitur Menfess & Confess"},
{title: "ℹ️ ┆» 𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻 𝗠𝗲𝗻𝘂", rowId: prefix+"informationcmd", description: "Menampilkan Fitur Information"},
{title: "🕵️‍♀️ ┆» 𝗦𝘁𝗮𝗹𝗸𝗲𝗿 𝗠𝗲𝗻𝘂", rowId: prefix+"stalkercmd", description: "Menampilkan Fitur Stalker"},
{title: "🔍 ┆» 𝗦𝗲𝗮𝗿𝗰𝗵 𝗠𝗲𝗻𝘂", rowId: prefix+"searchcmd", description: "Menampilkan Fitur Search"},
{title: "🗳️ ┆» 𝗖𝗼𝗻𝘃𝗲𝗿𝘁 𝗠𝗲𝗻𝘂", rowId: prefix+"convertcmd", description: "Menampilkan Fitur Convert"},
{title: "😸 ┆» 𝗙𝘂𝗻 𝗠𝗲𝗻𝘂", rowId: prefix+"funcmd", description: "Menampilkan Fitur Fun (Bersenang-Senang)"},
{title: "🦜 ┆» 𝗣𝗿𝗶𝗺𝗯𝗼𝗻 𝗠𝗲𝗻𝘂", rowId: prefix+"primboncmd", description: "Menampilkan Fitur Primbon"},
{title: "📒 ┆» 𝗧𝗲𝘅𝘁𝗽𝗿𝗼➊ 𝗠𝗲𝗻𝘂", rowId: prefix+"textpro1cmd", description: "Menampilkan Fitur Textpro dengan Text1"},
{title: "📒 ┆» 𝗧𝗲𝘅𝘁𝗽𝗿𝗼➋ 𝗠𝗲𝗻𝘂", rowId: prefix+"textpro2cmd", description: "Menampilkan Fitur Textpro dengan text1|Text2"},
{title: "📓 ┆» 𝗘𝗽??𝗼𝘁𝗼 𝗠𝗲𝗻𝘂", rowId: prefix+"ephotocmd", description: "Menampilkan Fitur Ephoto"},
{title: "👩 ┆» 𝗔𝘀𝘂𝗽𝗮𝗻 𝗠𝗲𝗻𝘂", rowId: prefix+"asupancmd", description: "Menampilkan Fitur Asupan"},
{title: "💦 ┆» 𝗡𝘀𝗳𝘄 𝗠𝗲𝗻𝘂", rowId: prefix+"nsfwcmd", description: "Menampilkan Fitur Nsfw"},
{title: "🛍️ ┆» 𝗦𝘁𝗼𝗿𝗲 𝗠𝗲𝗻𝘂", rowId: prefix+"storecmd", description: "Menampilkan Fitur Store"},
{title: "🧮 ┆» 𝗞𝗮𝗹𝗸𝘂𝗹𝗮𝘁𝗼𝗿 𝗠𝗲𝗻𝘂", rowId: prefix+"kalkulatorcmd", description: "Menampilkan Fitur Kalkulator"},
{title: "⬇️ ┆» 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱 𝗠𝗲𝗻𝘂", rowId: prefix+"downloadcmd", description: "Menampilkan Fitur Download"},
{title: "🦠 ┆» 𝗕𝘂𝗴 𝗠𝗲𝗻𝘂", rowId: prefix+"bugvipcmd", description: "Menampilkan Fitur Bug"},
]}],
footer: footer_nya,
mentions:[setting.ownerNumber, sender]})
}
break
case 'maincommand':case 'maincmd':case 'mainmenu':{
const more = String.fromCharCode(8206)
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${mainmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
location: { jpegThumbnail: await reSize(fs.readFileSync(`${setting.logoMenu}`), 300, 150) },
caption: menu_nya,
buttons: btn_menu,
footer: footer_nya,
...
conn.sendMessage(from, but_menu)
}
break
case 'anonymouscommand':case 'anonymouscmd':case 'anonymousmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
const mark_slebew = '0@s.whatsapp.net'
var no = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${anonymousmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'menfesscommand':case 'menfesscmd':case 'menfessmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
const mark_slebew = '0@s.whatsapp.net'
var no = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${menfessmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'ownercommand':case 'ownercmd':case 'ownermenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${ownermenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'searchcommand':case 'searchcmd':case 'searchmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${searchmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'downloadcommand':case 'downloadcmd':case 'downloadmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${downloadmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'informationcommand':case 'informationcmd':case 'informationmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${informationmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'convertcommand':case 'convertcmd':case 'convertmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${convertmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'gamecommand':case 'gamecmd':case 'gamemenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${gamemenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'groupcommand':case 'groupcmd':case 'groupmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${groupmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'stalkercommand': case 'stalkercmd': case 'stalkermenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${stalkermenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'kalkulatorcommand':case 'kalkulatorcmd':case 'kalkulatormenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${kalkulatormenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'storecommand':case 'storecmd':case 'storemenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${storemenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'audiocommand':case 'audiocmd':case 'audiomenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${audiomenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'nsfwcommand':case 'nsfwcmd':case 'nsfwmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${nsfwmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'asupancommand':case 'asupancmd':case 'asupanmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${asupanmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'soundcommand':case 'soundcmd':case 'soundmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${soundmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'funcommand':case 'funcmd':case 'funmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${funmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'randomcommand':case 'randomcmd':case 'randommenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${randommenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'primboncommand':case 'primboncmd':case 'primbonmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${primbonmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'textpro1command':case 'textpro1cmd':case 'textpro1menu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${textpro1menu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'textpro2command':case 'textpro2cmd':case 'textpro2menu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${textpro2menu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'ephotocommand':case 'ephotocmd':case 'ephotomenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${ephotomenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'bugvipcommand':case 'bugvipcmd':case 'bugvipmenu':{
const more = String.fromCharCode(8206)
const readmore = more.repeat(4001)
var no = 1
var ad = 1
...
let simbol = `${pickRandom(["⭔","⌬","𓄼","»"])}`
var footer_nya =`${setting.foother}`
var menu_nya =`${bugvipmenu(sender,simbol,ad,no)}`
let btn_menu = [
{buttonId: `${prefix}listmenu`, buttonText: { displayText: '䳈 Bᴀᴄᴋ' }, type: 1 },
]
var but_menu = {
...
break
case 'thanksto':case 'contributors':case 'contributor':{
	let ayank = `*⫍ THANKS TO ⫎*
   •Allah Swt
   •Ortu
   •IyanXv *[Creator]*
...
conn.sendMessage(from, { text: text_rules }, { quoted: msg })
}
break
...
conn.sendMessage(sender, { video: { url: result.result.url }, mimetype: 'video/mp4', fileName: `${result.result.title}.mp4`, caption: `⭔Title : ${result.result.title}\n⭔Channel : ${result.result.channel}\n⭔Published : ${result.result.published}\n⭔View : ${result.result.views}\n⭔Url : ${q}\n`}, { quoted: fkontak })
if (isGroup) {
...
conn.sendMessage(sender, { audio: { url: result.result.url }, mimetype: 'audio/mpeg', fileName: `${result.result.title}.mp3`}, { quoted: fkontak })
if (isGroup) {
reply("Media sedang dikirim di private chat")
}
}
...
conn.sendMessage(from, { image: { url: anu }, caption: teks }, { quoted: msg })
}
break
case 'infogempa':{
if (cekUser("id", sender) == null) return conn.sendMessage(from, { text: mess.OnlyUser, footer: `Powerd By - @${setting.kontakOwner}`, mentions: [setting.ownerNumber, sender]}, { quoted: fkontak })
...
if (msg.message) {
let biobot = "I’m "+setting.botName+"🤖 || Runtime : "+runtime(process.uptime())+"⏰ || "+("id", db_user).length+" Users"
...
await reply("Wait Kak Lagi Proses Mohon Tunggu")
let tik = await fetchJson(`https://api.tiklydown.me/api/download?url=${q}`)
let vidtik = await conn.sendMessage(from, { video: { url: tik.video.noWatermark }, caption: `❒ Download Video & Audio Tiktok
...
reply(mess.wait)
let amu =`https://api.zeeoneofc.my.id/api/ephoto360/${command}?text=${q}&apikey=${setting.zeeonekey}`
conn.sendMessage(from, {image: { url: amu }, caption: `Hasil dari ${command}`}, { quoted: msg})
}
break
...
if (cekUser("id", sender) == null) return conn.sendMessage(from, { text: mess.OnlyUser, footer: `Powerd By - @${setting.kontakOwner}`, mentions: [setting.ownerNumber, sender]}, { quoted: fkontak })
reply(mess.wait)
let asupan = await (`https://api.zeeoneofc.my.id/api/asupan/${command}?apikey=${setting.zeeonekey}`)
...
conn.sendMessage(from, { image: { url: `https://api.zeeoneofc.my.id/api/nsfw/${command}?apikey=${setting.zeeonekey}`}, caption: `Nih ${command}📸` }, { quoted: msg })
}
break
...
if (cekUser("id", sender) == null) return conn.sendMessage(from, { text: mess.OnlyUser, footer: `Powerd By - @${setting.kontakOwner}`, mentions: [setting.ownerNumber, sender]}, { quoted: fkontak })
reply(mess.wait)
var inicdd = await getBuffer(`https://api.zeeoneofc.my.id/api/sound/${command}?apikey=${setting.zeeonekey}`)
